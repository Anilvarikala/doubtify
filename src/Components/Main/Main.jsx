    ...
    <div className="Main-container">
      ...
      {!showResult ? (
        <>
          ...
          <div className="cards">
            <div className="card" onClick={() => onSent("Suggest me the best movies in telugu cinema")}>
              <p>Suggest me the best movies in telugu cinema.</p>
              <img src={assets.compass_icon} alt="" />
            </div>
            <div className="card" onClick={() => onSent("Give me the history and evoultion of artifical intelligence.")}>
              <p>
                Give me the history and evoultion of artifical intelligence.
              </p>
              <img src={assets.bulb_icon} alt="" />
            </div>
            <div className="card" onClick={() => onSent("Prepare me today with my daily challenges.")}>
              <p>Prepare me today with my daily challenges.</p>
              <img src={assets.message_icon} alt="" />
            </div>
            <div className="card" onClick={() => onSent("Lets do chatting for an 4 hours daily to improve my writing")}>
              <p>
